...
export function Footer() {
  ...
  return (
    <footer id="contacts" className="relative bg-muted/50 border-t py-20 md:py-28 overflow-hidden animate-in fade-in-0 duration-500">
      <div className="container relative z-10">
        <div className="mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-primary">Контакты</h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12">
            ...
            <div className="space-y-6 col-span-1 sm:col-span-2 lg:col-span-1">
                <div>
                    ...
                    <p className="text-lg font-bold">Ильхом Мамурович</p>
                    <a href="tel:+998997278020" className="text-base text-foreground hover:text-primary transition-colors">+998 99 727 80 20</a>
                    <br/>
                    <a href="mailto:info@ttgroup.uz" className="text-base text-foreground hover:text-primary transition-colors">info@ttgroup.uz</a>
                </div>
                <div>
        ...
        <div className="mt-20 border-t pt-8 text-center text-muted-foreground text-sm">
             <p>&copy; {new Date().getFullYear()} TourEast Transport Group. Все права защищены.</p>
        </div>

      </div>
      
      <div className="absolute bottom-8 left-0 right-0 z-0 text-center select-none pointer-events-none">
        <h1 className="text-[8vw] lg:text-[120px] font-extrabold text-foreground/5 uppercase tracking-wider leading-none break-words">
